...
EXPECTED_SHA256="58998fac2b943890e07ce9dc8dca9e336a0d0e24348a9defe36cf36dcfaa8eb1"
...
echo "TEN-MINUTE TEST VIDEO OK: 600 seconds, H.264 + AAC, sha256=$EXPECTED_SHA256"
